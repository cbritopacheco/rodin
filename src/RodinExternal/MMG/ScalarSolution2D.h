...
namespace Rodin::External::MMG
{
  ...
  class ScalarSolution2D :  public ScalarSolution
  {
    public:
       ...
       * @internal
       */
      ScalarSolution2D(MMG5_pSol sol, Mesh2D& mesh);
       ...
       * @param[in] other Object to move.
       */
      ScalarSolution2D& operator=(ScalarSolution2D&& other) = default;
   ...
   * @endcode
   */
  class IncompleteScalarSolution2D : public IncompleteSolutionBase
  {
    public:
      IncompleteScalarSolution2D();

      IncompleteScalarSolution2D(const IncompleteScalarSolution2D& other)
        : IncompleteSolutionBase(other)
      {}

      IncompleteScalarSolution2D(IncompleteScalarSolution2D&& other)
      ...
      ScalarSolution2D setMesh(Mesh2D& mesh)
      {
        return ScalarSolution2D(release(), mesh);
      }
  };
}
#endif
