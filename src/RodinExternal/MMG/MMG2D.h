 ...
 */
#ifndef RODIN_RODININTEGRATION_MMG_MMG2D_H
#define RODIN_RODININTEGRATION_MMG_MMG2D_H
...
{
  /**
   * @brief Base class for MMG2D operations.
   */
  class MMG2D
  {
    public:
       ...
       */
      virtual MMG2D& setHMin(double hmin) = 0;
       ...
       * @see [EXTERNAL: -hmin / -hmax](https://www.mmgtools.org/mmg-remesher-try-mmg/mmg-remesher-options/hmin-hmax)
       */
      virtual MMG2D& setHMax(double hmax) = 0;
       ...
       */
      virtual MMG2D& setHausdorff(double hausd) = 0;
       ...
       */
      virtual MMG2D& setGradation(double hgrad) = 0;
  };
}
