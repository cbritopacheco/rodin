 ...
 * @brief Line segment primitive for 2D Euclidean geometry computations.
 */
#ifndef RODIN_GEOMETRY_EUCLIDEAN_LINESEGMENT2D_HPP
#define RODIN_GEOMETRY_EUCLIDEAN_LINESEGMENT2D_HPP
...
namespace Rodin::Geometry::Euclidean
{
  ...
  inline
  constexpr
  Optional<Point2D<T>> LineSegment2D<T>::intersect(const
