...
/**
 * @file Line2D.hpp
 * @brief Infinite line primitive for 2D Euclidean geometry computations.
 */
#ifndef RODIN_GEOMETRY_EUCLIDEAN_LINE2D_HPP
#define RODIN_GEOMETRY_EUCLIDEAN_LINE2D_HPP
