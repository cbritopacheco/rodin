...
namespace Rodin::Variational
{
  ...
  /**
   * @ingroup IntegralSpecializations
   * @brief Integration of the Potential of a Trial ShapeFunction and 
   *
   */
          ...
          ShapeFunctionBase<RHSDerived, TestFES, TestSpace>>>
  {
    public:
      ...
      /// Type of the left operand of the dot product
      using LHS = ShapeFunctionBase<Potential<KernelType, ShapeFunctionBase<LHSDerived, TrialFES, TrialSpace>>>;
