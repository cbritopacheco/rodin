...
namespace Rodin::QF
{
  const Geometry::GeometryIndexed<std::vector<Math::SpatialVector>> QF1P1::s_points =
  {
    { Geometry::Polytope::Type::Point,
      std::vector{ Math::SpatialVector{{0}} } },
    { Geometry::Polytope::Type::Segment,
      std::vector{ Math::SpatialVector{{0.5}} } },
    { Geometry::Polytope::Type::Triangle,
      std::vector{ Math::SpatialVector{{ Scalar(1) / Scalar(3), Scalar(1) / Scalar(3) }} } },
    { Geometry::Polytope::Type::Quadrilateral,
      std::vector{ Math::SpatialVector{{0.5, 0.5}} } },
    { Geometry::Polytope::Type::Tetrahedron,
      std::vector{ Math::SpatialVector{{0.25, 0.25, 0.25}} } }
  };
