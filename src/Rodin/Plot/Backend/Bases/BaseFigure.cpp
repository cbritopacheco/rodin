...
namespace Rodin::Plot::Backend::Bases
{
  ...
  Magnum::Math::Vector2<int> BaseFigure::getFrameBufferSize() const
  {
  ...
  Magnum::Math::Vector2<int> BaseFigure::getWindowSize() const
  {
    Magnum::Math::Vector2<int> size;
  ...
  Magnum::Math::Vector2<float> BaseFigure::getDPIScaling() const
  {
    Magnum::Math::Vector2<float> dpi;
