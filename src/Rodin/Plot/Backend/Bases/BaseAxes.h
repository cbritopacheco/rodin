...
namespace Rodin::Plot::Backend::Bases
{
  class BaseAxes
  {
    public:
      ...
      const Magnum::Math::Vector<Scalar>2<Integer>& getSize() const;

      const Magnum::Math::Vector<Scalar>2<Integer>& getBottomLeft() const;
    ...
    private:
      ...
      Magnum::Math::Vector<Scalar>2<Integer> m_bottomLeft;
      Magnum::Math::Vector<Scalar>2<Integer> m_size;
