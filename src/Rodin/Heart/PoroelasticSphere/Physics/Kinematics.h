...
namespace Rodin::Heart::PoroelasticSphere::Physics
{
  ...
  struct RadialPoint
  {
      ...
      Scalar ltDot_y = 0,
             ltDot_phi = 0; ///< Total derivatives of @f$ \dot\lambda_\theta @f$.
  ...
  class WallKinematics
  {
    public:
        ...
        const EvalData& data, const decltype(std::declval<EvalData>().y) R) const
      {
        ...
        q.dv1_y =
          -Scalar(2) * (q.lr_y * q.v1 / r + q.lr * q.v1_y / r - q.lr * q.v1 * q.v1 / r2);
        q.dv1_phi = -Scalar(2) *
          (q.lr_phi * q.v1 / r + q.lr * q.v1_phi / r - q.lr * q.v1 * q.v2 / r2);
        q.dv2_y = -Scalar(2) * R * R * q.v1 / (r2 * r) -
          Scalar(2) * (q.lr_y * q.v2 / r + q.lr * q.v2_y / r - q.lr * q.v2 * q.v1 / r2);
        q.dv2_phi = -Scalar(2) * R * R * q.v2 / (r2 * r) -
          Scalar(2) *
            (q.lr_phi * q.v2 / r + q.lr * q.v2_phi / r - q.lr * q.v2 * q.v2 / r2);
        ...
        const Scalar rDot_phi =
          q.v1_phi * data.yDot + q.v2_phi * data.phiDot + q.v2 * data.a0;
        q.ltDot = rDot / R;
        q.ltDot_y = rDot_y / R;
