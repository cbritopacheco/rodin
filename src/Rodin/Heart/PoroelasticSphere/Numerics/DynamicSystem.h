...
namespace Rodin::Heart::PoroelasticSphere::Numerics
{
  ...
  class DynamicSystem
  {
    public:
      ...
      void buildEvalData(const DenseVector& candidateUnknowns,
        const StateType& currentState, const StateType& previousState,
        typename DenseVector::Scalar tnp1, typename DenseVector::Scalar dt,
      ...
      void evaluateResidual(const EvalData& evalData, DenseVector& residualVector) const
      {
