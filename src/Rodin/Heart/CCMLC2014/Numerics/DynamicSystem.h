    ...
    public:
          ...
          DenseVector& residualVector) const
      {
        ...
        residualVector[Model::ArterialPressure] =
          m_input.Cp * parDot
          + (evalData.par - evalData.pd) / m_input.Rp
          - evalData.windkesselOutflow;

        residualVector[Model::DistalPressure] =
          m_input.Cd * pdDot
          + (evalData.pd - evalData.par) / m_input.Rp
          - (m_input.pSv(evalData.tnp1) - evalData.pd) / m_input.Rd;
          ...
          typename DenseMatrix::Scalar) const
      {
        ...
        jacobianMatrix(Model::ArterialPressure, Model::ArterialPressure) =
          m_input.Cp * a0 + Scalar(1) / m_input.Rp
        ...
        jacobianMatrix(Model::DistalPressure, Model::DistalPressure) =
          m_input.Cd * a0 + Scalar(1) / m_input.Rp + Scalar(1) / m_input.Rd;
