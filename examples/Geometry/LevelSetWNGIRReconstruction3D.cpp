...
namespace
{
  ...
  // node positions. The WNGIR solve then sees a curved geometry whose
  // mid-edge nodes are free to move with the P2 displacement field.
...
int main(int argc, char** argv)
{
  ...
  const Real cz = parseRealOption(argc, argv, "cz", Real(0.5));
