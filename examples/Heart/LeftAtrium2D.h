...
/**
 * @file LeftAtrium2D.h
 * @brief Two-dimensional left atrium with a rectangular appendage.
 *
 ...
 *
 *   inlets (PV) : p = p_pv(t)   read from resources/examples/Heart/LeftAtrium2D/PulmonaryVeinPressureSR.dat
 *   outlet (MV) : p = p_v(t)    read from resources/examples/Heart/LeftAtrium2D/MitralValvePressureSR.dat
 ...
 * are not cosmetic:
 *
 *   1. The mesh is genuinely two-dimensional.  RectLAA.mesh is written as
 ...
 *      not the in-plane one.  LeftAtrium2D/make_la2d_mesh.py flattens it once; this
