...
namespace Rodin::Examples::Heart
{
  class CoupledLV0DCoronary3D
  {
    public:
      ...
      using DisplacementGridFunctionType =
          Rodin::PETSc::Variational::GridFunction<DisplacementFESType>;

      using DisplacementTrialFunctionType =
          Rodin::PETSc::Variational::TrialFunction<
              DisplacementGridFunctionType,
              DisplacementFESType>;

      using DisplacementTestFunctionType =
          Rodin::PETSc::Variational::TestFunction<DisplacementFESType>;
      ...
      using FlowProblemType = Rodin::Variational::Problem<
          ...
          DisplacementTrialFunctionType,
          VelocityTestFunctionType,
          PressureTestFunctionType,
          DisplacementTestFunctionType>;
