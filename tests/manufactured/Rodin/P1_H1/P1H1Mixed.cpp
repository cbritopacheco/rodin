...
{
  template <size_t NX, size_t NY, size_t NZ = 1, size_t K = 1>
  ...
  void runMixedTest(const Fixture& fixture, const FHandle& rhs)
  {
    ...
    P1 p1h_scalar(mesh);
    H1 h1(mesh, std::integral_constant<size_t, Fixture::K>{});
  ...
  {
    runMixedTest(*this, rhs_polynomial);
  }

  TEST_P(Manufactured_P1H1_Mixed_Test_10x10_K1, P1H1_Mixed_SineRHS)
  {
    runMixedTest(*this, rhs_sine);
  }
  ...
  TEST_P(Manufactured_P1H1_Mixed_Test_10x10_K2, P1H1_Mixed_SineRHS_K2)
  {
    runMixedTest(*this, rhs_sine);
  }
