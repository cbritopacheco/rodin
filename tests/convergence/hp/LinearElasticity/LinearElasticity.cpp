...
namespace Rodin::Tests::Convergence::HP::LinearElasticity
{
  ...
  TEST_P(HPConvergenceTest, AnalyticDisplacementImprovesAlongCombinedPath)
  {
    ...
    history.append(1, ::Rodin::Tests::Convergence::LinearElasticity::solve<1>(
      grid.makeMesh(2), data))
           .append(0.5, ::Rodin::Tests::Convergence::LinearElasticity::solve<2>(
      grid.makeMesh(3), data))
           .append(0.25, ::Rodin::Tests::Convergence::LinearElasticity::solve<3>(
      grid.makeMesh(5), data));
