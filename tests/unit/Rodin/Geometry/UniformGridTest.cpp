...
{
  {
    Mesh mesh = SerialMesh::UniformGrid(Polytope::Geometry::Triangle, 2, 2);
    EXPECT_EQ(mesh.getVertexCount(), 4);
    EXPECT_EQ(mesh.getElementCount(), 2);
  }

  {
    Mesh mesh = SerialMesh::UniformGrid(Polytope::Geometry::Triangle, 2, 3);
    EXPECT_EQ(mesh.getVertexCount(), 6);
    EXPECT_EQ(mesh.getElementCount(), 4);
  }

  {
    Mesh mesh = SerialMesh::UniformGrid(Polytope::Geometry::Triangle, 3, 2);
    EXPECT_EQ(mesh.getVertexCount(), 6);
    EXPECT_EQ(mesh.getElementCount(), 4);
  }

  {
    Mesh mesh = SerialMesh::UniformGrid(Polytope::Geometry::Triangle, 5, 10);
    EXPECT_EQ(mesh.getVertexCount(), 50);
    EXPECT_EQ(mesh.getElementCount(), 72);
  }

  {
    Mesh mesh = SerialMesh::UniformGrid(Polytope::Geometry::Triangle, 4, 9);
