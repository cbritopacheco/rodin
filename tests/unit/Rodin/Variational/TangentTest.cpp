...
{
  TEST(Rodin_Variational_Tangent, RealFunction_Zero)
  {
    RealFunction f(0.0);
    auto tan_result = Tangent(f);
  ...
  TEST(Rodin_Variational_Tangent, RealFunction_PiOverFour)
  {
  ...
  TEST(Rodin_Variational_Tangent, RealFunction_Pi)
  {
    RealFunction f(M_PI);
    auto tan_result = Tangent(f);
  ...
  TEST(Rodin_Variational_Tangent, RealFunction_MinusPiOverFour)
  {
    RealFunction f(-M_PI / 4.0);
    auto tan_result = Tangent(f);
  ...
  TEST(Rodin_Variational_Tangent, RealFunction_PiOverSix)
  {
  ...
  TEST(Rodin_Variational_Tangent, RealFunction_PiOverThree)
  {
  ...
  TEST(Rodin_Variational_Tangent, GridFunction_Tangent)
  {
  ...
  TEST(Rodin_Variational_Tangent, ChainedOperations)
  {
    RealFunction f(M_PI / 6.0);
    auto tan_f = Tangent(f);          // tan(π/6) = 1/√3
    auto tan_tan_f = Tangent(tan_f);  // tan(1/√3)
  ...
  TEST(Rodin_Variational_Tangent, Periodicity)
  {
    RealFunction f1(M_PI / 6.0);
    RealFunction f2(M_PI / 6.0 + M_PI);
    auto tan1 = Tangent(f1);
    auto tan2 = Tangent(f2);
  ...
  TEST(Rodin_Variational_Tangent, SmallAngle)
  {
  ...
  TEST(Rodin_Variational_Tangent, TangentOddFunction)
  {
    RealFunction f(M_PI / 6.0);
    RealFunction neg_f(-M_PI / 6.0);
    auto tan_f = Tangent(f);
    auto tan_neg_f = Tangent(neg_f);
  ...
  TEST(Rodin_Variational_Tangent, TangentSineCosineIdentity)
  {
    RealFunction f(M_PI / 6.0);
    auto sin_f = Sine(f);
    auto cos_f = Cosine(f);
  ...
  TEST(Rodin_Variational_Tangent, TangentWithMultiplication)
  {
    RealFunction f(M_PI / 8.0);
    RealFunction scalar(2.0);
    auto product = scalar * f;  // 2 * π/8 = π/4
    auto tan_product = Tangent(product);  // tan(π/4) = 1
  ...
  TEST(Rodin_Variational_Tangent, TangentLargeAngle)
  {
  ...
  TEST(Rodin_Variational_Tangent, TangentPositiveNegative)
  {
  ...
  TEST(Rodin_Variational_Tangent, TangentSecantIdentity)
  {
    RealFunction f(M_PI / 6.0);
    auto tan_f = Tangent(f);
  ...
  TEST(Rodin_Variational_Tangent, TangentWithAbs)
  {
    RealFunction f(-M_PI / 4.0);
    auto abs_f = Abs(f);        // |−π/4| = π/4
    auto tan_abs = Tangent(abs_f);   // tan(π/4) = 1
  ...
  TEST(Rodin_Variational_Tangent, TangentSpecialAngles)
  {
  ...
  TEST(Rodin_Variational_Tangent, TangentContinuity)
  {
    // Test values approaching but not at π/2 where tangent has asymptotes
