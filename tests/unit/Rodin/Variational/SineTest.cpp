...
{
  TEST(Rodin_Variational_Sine, RealFunction_Zero)
  {
    RealFunction f(0.0);
    auto sin_result = Sine(f);
  ...
  TEST(Rodin_Variational_Sine, RealFunction_PiOverTwo)
  {
  ...
  TEST(Rodin_Variational_Sine, RealFunction_Pi)
  {
    RealFunction f(M_PI);
    auto sin_result = Sine(f);
  ...
  TEST(Rodin_Variational_Sine, RealFunction_ThreePiOverTwo)
  {
  ...
  TEST(Rodin_Variational_Sine, RealFunction_TwoPi)
  {
  ...
  TEST(Rodin_Variational_Sine, RealFunction_PiOverSix)
  {
  ...
  TEST(Rodin_Variational_Sine, RealFunction_PiOverFour)
  {
  ...
  TEST(Rodin_Variational_Sine, RealFunction_PiOverThree)
  {
  ...
  TEST(Rodin_Variational_Sine, RealFunction_NegativeValue)
  {
    RealFunction f(-M_PI / 6.0);
    auto sin_result = Sine(f);
  ...
  TEST(Rodin_Variational_Sine, GridFunction_SineWave)
  {
  ...
  TEST(Rodin_Variational_Sine, ChainedOperations)
  {
    RealFunction f(M_PI / 6.0);
    auto sin_f = Sine(f);          // sin(π/6) = 0.5
    auto sin_sin_f = Sine(sin_f);  // sin(0.5) ≈ 0.479426
  ...
  TEST(Rodin_Variational_Sine, Periodicity)
  {
  ...
  TEST(Rodin_Variational_Sine, SmallAngle)
  {
  ...
  TEST(Rodin_Variational_Sine, LargeAngle)
  {
  ...
  TEST(Rodin_Variational_Sine, SineSquaredIdentity)
  {
    RealFunction f(M_PI / 3.0);
    auto sin_f = Sine(f);
    auto sin_squared = sin_f * sin_f;
    
    // Also create cos²(x) to test sin²(x) + cos²(x) = 1 in a separate test if Cosine is available
  ...
  TEST(Rodin_Variational_Sine, SineWithMultiplication)
  {
    RealFunction f(M_PI / 6.0);
    RealFunction scalar(2.0);
    auto product = scalar * f;  // 2 * π/6 = π/3
    auto sin_product = Sine(product);  // sin(π/3) = √3/2
  ...
  TEST(Rodin_Variational_Sine, SineOddFunction)
  {
    RealFunction f(M_PI / 4.0);
    RealFunction neg_f(-M_PI / 4.0);
    auto sin_f = Sine(f);
    auto sin_neg_f = Sine(neg_f);
