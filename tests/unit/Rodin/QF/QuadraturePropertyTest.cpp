 ...
 *
 * XiaoGimbutas and WitherdenVincent are independent published families and
 * produce different point counts. Two rules of the same strength must
 * nevertheless integrate every polynomial of that degree identically.
 */
...
/// polynomial of degree p. This cross-checks neighbouring rows of the table.
